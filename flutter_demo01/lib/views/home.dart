...
class _HomeState extends State<Home> {
  List<PopularTourModel> popularTourModels = getPopularTours();
  List<CountryModel> country = getCountrys();
  @override
  void initState() {
    // country = getCountrys();
...
class PopularTours extends StatelessWidget {
  ...
  PopularTours(this.imgUrl, this.rating, this.desc, this.price, this.title);
